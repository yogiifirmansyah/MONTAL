...
@section('title') Kemandirian Emosional @endsection
...
<div class="row">
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                <button type="button" id="addLaporanPerkembangan" class="btn btn-success btn-rounded w-lg mb-5" data-bs-toggle="modal" data-bs-target="#myModal">Tambah Kemandirian Emosional</button>
