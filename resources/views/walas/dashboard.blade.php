    ...
    <div class="col-md-4">
        <div class="card">
            <div class="card-body">
                ...
                <div>
                    <h4 class="mb-1 mt-1"><span data-plugin="counterup">{{ count($siswas) }}</span></h4>
...
<h4>Persentase Laporan</h4>
<div class="row">
    <div class="col-md-4">
        <div class="card">
            <div class="card-body">
                <div class="float-end mt-2">
                    <div id="bimbingan-fisik" data-colors='["--bs-primary"]'> </div>
                </div>
                <div>
                    <h4 class="mb-1 mt-1"><span data-plugin="counterup">{{ $totalLaporanBimbinganFisik }}</span></h4>
                    <p class="text-muted mb-0">Bimbingan Fisik</p>
                </div>
                <p class="text-muted mt-3 mb-0"><span class="text-danger me-1">{{ number_format($persentaseBimbinganFisik, 2, '.', '') }}%</span>
                </p>
            </div>
        </div>
    </div> <!-- end col-->
    ...
    <div class="col-md-4">
        <div class="card">
            <div class="card-body">
                <div class="float-end mt-2">
                    <div id="bimbingan-mental" data-colors='["--bs-info"]'> </div>
                </div>
                <div>
                    <h4 class="mb-1 mt-1"><span data-plugin="counterup">{{ $totalLaporanBimbinganMental }}</span></h4>
                    <p class="text-muted mb-0">Bimbingan Mental</p>
                </div>
                <p class="text-muted mt-3 mb-0"><span class="text-danger me-1">{{ number_format($persentaseBimbinganMental, 2, '.', '') }}%</span>
                </p>
            </div>
        </div>
    </div> <!-- end col-->
    ...
    <div class="col-md-4">
        <div class="card">
            <div class="card-body">
                <div class="float-end mt-2">
                    <div id="bimbingan-sosial" data-colors='["--bs-success"]'> </div>
                </div>
                <div>
                    <h4 class="mb-1 mt-1"><span data-plugin="counterup">{{ $totalLaporanBimbinganSosial }}</span></h4>
                    <p class="text-muted mb-0">Bimbingan Sosial</p>
                </div>
                <p class="text-muted mt-3 mb-0"><span class="text-danger me-1">{{ number_format($persentaseBimbinganSosial, 2, '.', '') }}%</span>
                </p>
            </div>
        </div>
    </div> <!-- end col-->
    ...
    <div class="col-md-4">
        <div class="card">
            <div class="card-body">
                <div class="float-end mt-2">
                    <div id="kemandirian-emosional" data-colors='["--bs-warning"]'> </div>
                </div>
                <div>
                    <h4 class="mb-1 mt-1"><span data-plugin="counterup">{{ $totalLaporanKemandirianEmosional }}</span></h4>
                    <p class="text-muted mb-0">Kemandirian Emosional</p>
                </div>
                <p class="text-muted mt-3 mb-0"><span class="text-danger me-1">{{ number_format($persentaseKemandirianEmosional, 2, '.', '') }}%</span>
                </p>
            </div>
        </div>
    </div> <!-- end col-->
    ...
    <div class="col-md-4">
        <div class="card">
            <div class="card-body">
                <div class="float-end mt-2">
                    <div id="kemandirian-perilaku" data-colors='["--bs-danger"]'> </div>
                </div>
                <div>
                    <h4 class="mb-1 mt-1"><span data-plugin="counterup">{{ $totalLaporanKemandirianPerilaku }}</span></h4>
                    <p class="text-muted mb-0">Kemandirian Perilaku</p>
                </div>
                <p class="text-muted mt-3 mb-0"><span class="text-danger me-1">{{ number_format($persentaseKemandirianPerilaku, 2, '.', '') }}%</span>
                </p>
            </div>
        </div>
    </div> <!-- end col-->
    ...
    <div class="col-md-4">
        <div class="card">
            <div class="card-body">
                <div class="float-end mt-2">
                    <div id="kemandirian-nilai" data-colors='["--bs-dark"]'> </div>
                </div>
                <div>
                    <h4 class="mb-1 mt-1"><span data-plugin="counterup">{{ $totalLaporanKemandirianNilai }}</span></h4>
                    <p class="text-muted mb-0">Kemandirian Nilai</p>
                </div>
                <p class="text-muted mt-3 mb-0"><span class="text-danger me-1">{{ number_format($persentaseKemandirianNilai, 2, '.', '') }}%</span>
                </p>
            </div>
        </div>
    </div> <!-- end col-->
...
*/
        ...
        // Bimbingan Fisik
        var BimbinganFisikChart = getChartColorsArray("bimbingan-fisik");
        if (BimbinganFisikChart) {
            var options = {
                fill: {
                    colors: BimbinganFisikChart,
                },
                series: [<?= $persentaseBimbinganFisik; ?>],
                chart: {
                    type: "radialBar",
                    width: 45,
                    height: 45,
            ...
            var chart = new ApexCharts(
                document.querySelector("#bimbingan-fisik"),
                options
            );
            chart.render();
        } //
        ...
        // Bimbingan Mental
        var BimbinganMentalChart = getChartColorsArray("bimbingan-mental");
        if (BimbinganMentalChart) {
            var options = {
                fill: {
                    colors: BimbinganMentalChart,
                },
                series: [<?= $persentaseBimbinganMental ?>],
                chart: {
                    type: "radialBar",
                    width: 45,
                    height: 45,
            ...
            var chart = new ApexCharts(
                document.querySelector("#bimbingan-mental"),
                options
            );
            chart.render();
        } //
        ...
        // Bimbingan Sosial
        var BimbinganSosialChart = getChartColorsArray("bimbingan-sosial");
        if (BimbinganSosialChart) {
            var options = {
                fill: {
                    colors: BimbinganSosialChart,
                },
                series: [<?= $persentaseBimbinganSosial; ?>],
                chart: {
                    type: "radialBar",
                    width: 45,
                    height: 45,
            ...
            var chart = new ApexCharts(
                document.querySelector("#bimbingan-sosial"),
                options
            );
            chart.render();
        } //
        ...
        var KemandirianEmosionalChart = getChartColorsArray("kemandirian-emosional");
        if (KemandirianEmosionalChart) {
            var options = {
                fill: {
                    colors: KemandirianEmosionalChart,
                },
                series: [<?= $persentaseKemandirianEmosional ?>],
                chart: {
                    type: "radialBar",
                    width: 45,
                    height: 45,
            ...
            var chart = new ApexCharts(
                document.querySelector("#kemandirian-emosional"),
                options
            );
            chart.render();
        } //
        ...
        var KemandirianPerilakuChart = getChartColorsArray("kemandirian-perilaku");
        if (KemandirianPerilakuChart) {
            var options = {
                fill: {
                    colors: KemandirianPerilakuChart,
                },
                series: [<?= $persentaseKemandirianPerilaku; ?>],
                chart: {
                    type: "radialBar",
                    width: 45,
                    height: 45,
            ...
            var chart = new ApexCharts(
                document.querySelector("#kemandirian-perilaku"),
                options
            );
            chart.render();
        } //
        ...
        // Kemandirian Nilai
        var KemandirianNilaiChart = getChartColorsArray("kemandirian-nilai");
        if (KemandirianNilaiChart) {
            var options = {
                fill: {
                    colors: KemandirianNilaiChart,
                },
                series: [<?= $persentaseKemandirianNilai ?>],
                chart: {
                    type: "radialBar",
                    width: 45,
                    height: 45,
            ...
            var chart = new ApexCharts(
                document.querySelector("#kemandirian-nilai"),
                options
            );
            chart.render();
        } //
