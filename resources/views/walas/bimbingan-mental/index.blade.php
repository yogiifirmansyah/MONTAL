...
@section('title') Bimbingan Mental @endsection

@section('content')

@component('common-components.breadcrumb')
@slot('pagetitle') Bimbingan Mental @endslot
@slot('title') Dashboard Bimbingan Mental @endslot
@endcomponent
...
<div class="row">
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                <button type="button" id="addLaporanPerkembangan" class="btn btn-success btn-rounded w-lg mb-5" data-bs-toggle="modal" data-bs-target="#myModal">Tambah Bimbingan Mental</button>
