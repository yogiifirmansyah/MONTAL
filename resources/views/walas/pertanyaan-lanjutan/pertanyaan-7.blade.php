        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <form action="{{ url('instrumen-1/pertanyaan-lanjutan-7') }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            ...
                            <a href="{{ url('instrumen-1') }}" class="btn btn-warning waves-effect waves-light w-md float-end mb-2">Skip</a>
                            @if (!empty($pertanyaan7Lanjutan))
                            <a href="{{ url('instrumen-1/pertanyaan-lanjutan-7/edit/'. $pertanyaanUmum->id) }}" class="btn btn-primary waves-effect waves-light w-md float-end mb-2 mx-1">Ubah Data</a>
                            <a href="javascript:void(0)" id="deletePertanyaanLanjutan" PertanyaanLanjutan_id="{{ $pertanyaan7Lanjutan->id }}" data-bs-toggle="modal" data-bs-target="#myModalDelete" class="btn btn-danger waves-effect waves-light w-md float-end mb-2 mx-1">Hapus Data</a>
                            @endif
                            <a href="{{ url('instrumen-1/pertanyaan-lanjutan-6/'. $pertanyaanUmum->id) }}" class="btn btn-dark waves-effect waves-light w-md float-end mb-2 mx-1">Kembali ke pertanyaan sebelumnya</a>
                            <table class="table table-bordered" width="100%">
                                <thead>
                                    <tr class="text-center">
                                        <th rowspan="2" width="10%">No</th>
