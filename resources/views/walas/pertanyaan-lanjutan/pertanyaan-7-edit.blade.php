        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <form action="{{ url('instrumen-1/pertanyaan-lanjutan-7/'.$pertanyaan7Lanjutan->id) }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                            <div class="card bg-warning px-3 pt-3">
                                <strong>Pertanyaan Lanjutan untuk Item yang terjawab Ya di nomor 6 dan/atau 7 dan/atau 8 dan/atau 9</strong>
                                <p class="text-light">Tekan tombol Skip dibawah jika Item terjawab Tidak untuk menuju ke pertanyaan selanjutnya</p>
                            </div>
                            <a href="{{ url('instrumen-1/pertanyaan-lanjutan-7/'. $pertanyaanUmum->id) }}" class="btn btn-danger waves-effect waves-light w-md float-end mb-2">Batal</a>
                            <table class="table table-bordered" width="100%">
                                <thead>
                                    <tr class="text-center">
                                        <th rowspan="2" width="10%">No</th>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="form-check">
                                                <input class="form-check-input" type="radio" name="item_1" value="Y" {{ !empty($pertanyaan7Lanjutan) != null && $pertanyaan7Lanjutan->item_1 == 'Y' ? 'checked' : '' }}>
                                            </div>
                                        </td>
                                        <td>
                                            <div class=" form-check">
                                                <input class="form-check-input" type="radio" name="item_1" value="N" {{ !empty($pertanyaan7Lanjutan) != null && $pertanyaan7Lanjutan->item_1 == 'N' ? 'checked' : '' }}>
                                            </div>
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td>
                                            <div class="form-check">
                                                <input class="form-check-input" type="radio" name="item_2" value="Y" {{ !empty($pertanyaan7Lanjutan) != null && $pertanyaan7Lanjutan->item_2 == 'Y' ? 'checked' : '' }}>
                                            </div>
                                        </td>
                                        <td>
                                            <div class=" form-check">
                                                <input class="form-check-input" type="radio" name="item_2" value="N" {{ !empty($pertanyaan7Lanjutan) != null && $pertanyaan7Lanjutan->item_2 == 'N' ? 'checked' : '' }}>
                                            </div>
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td>
                                            <div class="form-check">
                                                <input class="form-check-input" type="radio" name="item_3" value="Y" {{ !empty($pertanyaan7Lanjutan) != null && $pertanyaan7Lanjutan->item_3 == 'Y' ? 'checked' : '' }}>
                                            </div>
                                        </td>
                                        <td>
                                            <div class=" form-check">
                                                <input class="form-check-input" type="radio" name="item_3" value="N" {{ !empty($pertanyaan7Lanjutan) != null && $pertanyaan7Lanjutan->item_3 == 'N' ? 'checked' : '' }}>
                                            </div>
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td>
                                            <div class="form-check">
                                                <input class="form-check-input" type="radio" name="item_4" value="Y" {{ !empty($pertanyaan7Lanjutan) != null && $pertanyaan7Lanjutan->item_4 == 'Y' ? 'checked' : '' }}>
                                            </div>
                                        </td>
                                        <td>
                                            <div class=" form-check">
                                                <input class="form-check-input" type="radio" name="item_4" value="N" {{ !empty($pertanyaan7Lanjutan) != null && $pertanyaan7Lanjutan->item_4 == 'N' ? 'checked' : '' }}>
                                            </div>
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td>
                                            <div class="form-check">
                                                <input class="form-check-input" type="radio" name="item_5" value="Y" {{ !empty($pertanyaan7Lanjutan) != null && $pertanyaan7Lanjutan->item_5 == 'Y' ? 'checked' : '' }}>
                                            </div>
                                        </td>
                                        <td>
                                            <div class=" form-check">
                                                <input class="form-check-input" type="radio" name="item_5" value="N" {{ !empty($pertanyaan7Lanjutan) != null && $pertanyaan7Lanjutan->item_5 == 'N' ? 'checked' : '' }}>
                                            </div>
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td>
                                            <div class="form-check">
                                                <input class="form-check-input" type="radio" name="item_6" value="Y" {{ !empty($pertanyaan7Lanjutan) != null && $pertanyaan7Lanjutan->item_6 == 'Y' ? 'checked' : '' }}>
                                            </div>
                                        </td>
                                        <td>
                                            <div class=" form-check">
                                                <input class="form-check-input" type="radio" name="item_6" value="N" {{ !empty($pertanyaan7Lanjutan) != null && $pertanyaan7Lanjutan->item_6 == 'N' ? 'checked' : '' }}>
                                            </div>
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td>
                                            <div class="form-check">
                                                <input class="form-check-input" type="radio" name="item_7" value="Y" {{ !empty($pertanyaan7Lanjutan) != null && $pertanyaan7Lanjutan->item_7 == 'Y' ? 'checked' : '' }}>
                                            </div>
                                        </td>
                                        <td>
                                            <div class=" form-check">
                                                <input class="form-check-input" type="radio" name="item_7" value="N" {{ !empty($pertanyaan7Lanjutan) != null && $pertanyaan7Lanjutan->item_7 == 'N' ? 'checked' : '' }}>
                                            </div>
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td>
                                            <div class="form-check">
                                                <input class="form-check-input" type="radio" name="item_8" value="Y" {{ !empty($pertanyaan7Lanjutan) != null && $pertanyaan7Lanjutan->item_8 == 'Y' ? 'checked' : '' }}>
                                            </div>
                                        </td>
                                        <td>
                                            <div class=" form-check">
                                                <input class="form-check-input" type="radio" name="item_8" value="N" {{ !empty($pertanyaan7Lanjutan) != null && $pertanyaan7Lanjutan->item_8 == 'N' ? 'checked' : '' }}>
                                            </div>
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td>
                                            <div class="form-check">
                                                <input class="form-check-input" type="radio" name="item_9" value="Y" {{ !empty($pertanyaan7Lanjutan) != null && $pertanyaan7Lanjutan->item_9 == 'Y' ? 'checked' : '' }}>
                                            </div>
                                        </td>
                                        <td>
                                            <div class=" form-check">
                                                <input class="form-check-input" type="radio" name="item_9" value="N" {{ !empty($pertanyaan7Lanjutan) != null && $pertanyaan7Lanjutan->item_9 == 'N' ? 'checked' : '' }}>
                                            </div>
                                        </td>
                                    </tr>
                                </tbody>
