...
@section('title') Kemandirian Nilai @endsection

@section('content')

@component('common-components.breadcrumb')
@slot('pagetitle') Kemandirian Nilai @endslot
@slot('title') Dashboard Kemandirian Nilai @endslot
@endcomponent
...
<div class="row">
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                <button type="button" id="addLaporanPerkembangan" class="btn btn-success btn-rounded w-lg mb-5" data-bs-toggle="modal" data-bs-target="#myModal">Tambah Kemandirian Nilai</button>
