...
@slot('title') Tambah Data User @endslot
@endcomponent
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="date" class="form-control" id="verticalnav-phoneno-input" placeholder="+62xxx xxxx xxxx">
                                    </div>
                                </div><!-- end col-lg-6 -->
                                <div class="col-lg-6">
                                    <div class="mb-3">
                                        <label for="verticalnav-email-input">Tempat Lahir</label>
                                        <input type="text" class="form-control" id="verticalnav-email-input" placeholder="Surabaya">
                                    </div>
                                </div><!-- end col-lg-6 -->
                            </div><!-- end row -->
