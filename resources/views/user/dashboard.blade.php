    ...
    <div class="col-md-4">
        <div class="card">
            <div class="card-body">
                ...
                <div>
                    <h4 class="mb-1 mt-1"><span data-plugin="counterup">{{ $variabels }}</span></h4>
                    <p class="text-muted mb-0">Variabels</p>
                </div>
            </div>
        </div>
    </div> <!-- end col-->
    ...
    <div class="col-md-4">
        <div class="card">
            <div class="card-body">
                ...
                <div>
                    <h4 class="mb-1 mt-1"><span data-plugin="counterup">{{ $indikators }}</span></h4>
                    <p class="text-muted mb-0">Indikators</p>
                </div>
            </div>
        </div>
    </div> <!-- end col-->
    ...
    <div class="col-md-4">
        <div class="card">
            <div class="card-body">
                ...
                <div>
                    <h4 class="mb-1 mt-1"><span data-plugin="counterup">{{ $walikelas }}</span></h4>
    ...
    <div class="col-md-4">
        <div class="card">
            <div class="card-body">
                ...
                <div>
                    <h4 class="mb-1 mt-1"><span data-plugin="counterup">{{ $kelas }}</span></h4>
    ...
    <div class="col-md-4">
        <div class="card">
            <div class="card-body">
                ...
                <div>
                    <h4 class="mb-1 mt-1"><span data-plugin="counterup">{{ $siswa }}</span></h4>
