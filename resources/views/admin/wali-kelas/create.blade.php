...
<div class="row">
    <div class="col-lg-12">
        ...
        <div class="card">
            <form action="{{ url('admin/wali-kelas') }}" method="POST">
                @csrf
                <div class="card-body">
                    @if ($errors->any())
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" name="nip" id="verticalnav-firstname-input" placeholder="123456789">
                                    </div>
                                </div><!-- end col-lg-6 -->
                            </div><!-- end row -->
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" name="telp" id="verticalnav-phoneno-input" placeholder="+62xxx xxxx xxxx">
                                    </div>
                                </div><!-- end col-lg-6 -->
                                <div class="col-lg-6">
                                    <div class="mb-3">
