    ...
    <div data-simplebar class="sidebar-menu-scroll">
        ...
        <div id="sidebar-menu">
            ...
            <ul class="metismenu list-unstyled" id="side-menu">
                ...
                <li>
                    <a href="{{ url('/') }}">
                        <i class="dripicons-home"></i><span class="badge rounded-pill bg-primary float-end">01</span>
                        <span>Dashboard</span>
                    </a>
                </li>
                <li>
                ...
                <li class="menu-title">Bimbingan Fisik</li>
                <li>
                ...
                <li>
                    <a href="{{ route('dashboard.pemeliharaan-kesehatan.index') }}">
                        <i class="dripicons-heart"></i>
                        <span>Kesehatan</span>
                    </a>
                </li>
                
                <li class="menu-title">Bimbingan Mental</li>
                <li>
                ...
                <li>
                    <a href="{{ route('dashboard.kedisiplinan.index') }}">
                        <i class="dripicons-graph-line"></i>
                        <span>Kedispilinan</span>
                    </a>
                </li>
                
                <li class="menu-title">Penilaian Lainnya</li>
                <li>
                    <a href="{{ route('dashboard.bimbingan-sosial.index') }}">
                        <i class="bx bxs-group"></i>
                        <span>Bimbingan Sosial</span>
                    </a>
                </li>
                <li>
                    <a href="{{ route('dashboard.kemandirian-emosional.index') }}">
                        <i class="bx bx-angry"></i>
                        <span>Kemandirian Emosional</span>
                    </a>
                </li>
                <li>
                    <a href="{{ route('dashboard.kemandirian-perilaku.index') }}">
                        <i class="bx bx-street-view"></i>
                        <span>Kemandirian Perilaku</span>
                    </a>
                </li>
                <li>
                    <a href="{{ route('dashboard.kemandirian-nilai.index') }}">
