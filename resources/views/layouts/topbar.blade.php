<header id="page-topbar">
    ...
    <div class="dropdown d-inline-block">
        ...
        <div class="dropdown-menu dropdown-menu-end">
            ...
            @endif
            <a class="dropdown-item" href="{{ url('change-password') }}"><i class="uil uil-cog font-size-18 align-middle me-1 text-muted"></i> <span class="align-middle">Ubah Password</span></a>
